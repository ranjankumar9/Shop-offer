      ...
      <Grid container direction="row" justify="center" alignItems="center">
        <Grid item xs={12}>
          <AppBar position="static" style={{ background: "red" }}>
            <Toolbar>
              <img
                src="https://image-ap1.moengage.com/indianexpressmoengage/20220512052053646452TOTOW0Logojpegindianexpressmoengage.jpeg"
                alt="logo"
                style={{ height: 50 }}
                    ...
                    {activeStep === steps.length ? (
                      ...
                      <div>
                        ...
                        <div className={classes.actions}>
                          ...
                          <Button
                            variant="contained"
                            style={{ background: "#0aca3a", color: "#ffffff" }}
                            onClick={handleNext}
                            className={classes.button}
                          >
